 ...
 * ArrayAdapter
 */
public class OrderConfirmAdapter extends CommonAdapter<ResponseCheckOrder.ItemInfo> {
     ...
     * @param objects  一覧データ
     */
    public OrderConfirmAdapter(Context context, int resource, List<ResponseCheckOrder.ItemInfo> objects, OnItemClickListener onItemClickListener, String screenId) {
...
//	        str = convertShip(itemInfo.daysToShip, itemInfo.shipType);
            if (android.text.TextUtils.isEmpty(itemInfo.shipDate)) {

                str = getResourceString(R.string.label_hyphen);   //ハイフン化

            } else {

                str = itemInfo.shipDate;
            }

            setIncludeItemText(childView.findViewById(R.id.daysToShip), getResourceString(R.string.confirm_ship_date), str, false);
        }
...
//			str = null;
        ...
        Button button1 = (Button) expressType.findViewById(R.id.button1);

        if (itemInfo.expressType == null) {
            button1.setText(getResourceString(R.string.confirm_change_stoke));
        } else {
            button1.setText(getResourceString(R.string.confirm_change_stoke2));
        }
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mOnItemClickListener.onItemChange(OrderConfirmAdapter.this, null, position, getItemId(position));
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mOnItemClickListener.onItemToday(OrderConfirmAdapter.this, null, position, getItemId(position));
