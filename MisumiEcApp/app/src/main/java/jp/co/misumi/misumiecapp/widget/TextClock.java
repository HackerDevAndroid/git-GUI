...
//    public static final CharSequence DEFAULT_FORMAT_24_HOUR = "H:mm";
    ...
    private static final CharSequence DEFAULT_FORMAT_DATE = "yyyy/MM/dd";
    private static final String DEFAULT_FORMAT_WEEK = "(%s)";
    private static String[] DAY_OF_WEEK_STRING = new String[8];
...
*/
    ...
    private void init() {
		...
		DAY_OF_WEEK_STRING[1] = String.format(DEFAULT_FORMAT_WEEK, getResourceString(R.string.top_label_status_day_of_week_1));
		DAY_OF_WEEK_STRING[2] = String.format(DEFAULT_FORMAT_WEEK, getResourceString(R.string.top_label_status_day_of_week_2));
		DAY_OF_WEEK_STRING[3] = String.format(DEFAULT_FORMAT_WEEK, getResourceString(R.string.top_label_status_day_of_week_3));
		DAY_OF_WEEK_STRING[4] = String.format(DEFAULT_FORMAT_WEEK, getResourceString(R.string.top_label_status_day_of_week_4));
		DAY_OF_WEEK_STRING[5] = String.format(DEFAULT_FORMAT_WEEK, getResourceString(R.string.top_label_status_day_of_week_5));
		DAY_OF_WEEK_STRING[6] = String.format(DEFAULT_FORMAT_WEEK, getResourceString(R.string.top_label_status_day_of_week_6));
		DAY_OF_WEEK_STRING[7] = String.format(DEFAULT_FORMAT_WEEK, getResourceString(R.string.top_label_status_day_of_week_7));

		mBlueColor = getContext().getResources().getColor(R.color.color_top_label_menu);
...
//        }
    ...
    private void onTimeChanged() {
        ...
        String str = (String)DateFormat.format(DEFAULT_FORMAT_DATE, mTime);
        str += DAY_OF_WEEK_STRING[mTime.get(Calendar.DAY_OF_WEEK)];

		ss = SpannableUtil.newSpannableString(str, 13, mBlueColor, true);
        ssb.append(ss);
        ssb.append("\n");
        ssb.append("\n");

        str = (String)DateFormat.format(mFormat, mTime);
		ss = SpannableUtil.newSpannableString(str, 23, mBlueColor, true);
        ssb.append(ss);
